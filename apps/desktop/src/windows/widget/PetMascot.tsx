 ...
 *
 * The mascot is self-authored inline SVG art and carries no meaning: the svg
 * is hidden from assistive technology and the mood is exposed as plain text in
 * the status line. All animation is CSS on transform and opacity, so it can be
